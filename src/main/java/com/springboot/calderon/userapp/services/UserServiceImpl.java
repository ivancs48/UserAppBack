...
import com.springboot.calderon.userapp.models.IUser;
import com.springboot.calderon.userapp.models.UserDTO;
import com.springboot.calderon.userapp.repositories.RoleRepository;
import com.springboot.calderon.userapp.repositories.UserRepository;
...
public class UserServiceImpl implements UserService{
    ...
    private List<Roles> getRoles(IUser user) {
		List<Roles> roles = new ArrayList<>();
